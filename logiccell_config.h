...
#ifndef LOGICCELL_CONFIG_H_
#define LOGICCELL_CONFIG_H_

// ------------------------------------------------------------------------- //

// Platform recognition
#if defined(WIN32) || defined(_WIN32)
  #define LOGICCELLPLUGIN_WIN32 1
#elif defined(__linux)
  #define LOGICCELLPLUGIN_LINUX 1
#elif defined(__APPLE__)
  #define LOGICCELLPLUGIN_OSX 1
#else
  //unsupported OS
#endif
...
// all source files of the library, so you don't have to worry about a thing.
  ...
  #if defined(LOGICCELLPLUGIN_STATICLIB)
    #define LOGICCELL_API
  #else
    #if defined(LOGICCELLPLUGIN_SOURCE)
      // If we are building the DLL, export the symbols tagged like this
      #define LOGICCELL_API __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define LOGICCELL_API __declspec(dllimport)
    #endif
  #endif
  ...
  #else
    #if defined(LOGICCELLPLUGIN_SOURCE)
      #define LOGICCELL_API __attribute__ ((visibility ("default")))
    #else
